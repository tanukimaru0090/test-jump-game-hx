...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("test-jump-game", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("test-jump-game", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "test-jump-game";
		app.meta["name"] = "test-jump-game";
		...
		#elseif air
		app.window.title = "test-jump-game";
		#else
